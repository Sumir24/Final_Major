...
argument-hint: "[phase] [--research] [--skip-research] [--gaps] [--redo]"
---
...
- `--redo` — Force re-planning even if phase is marked complete in ROADMAP.md
...
## 4. Environment Setup (Compact Mode)
- Plans are written to `.gsd/PLAN.md` (current active plan)
- Historical data is kept in `.gsd/ARCHIVE.md`
...
**PowerShell:**
```powershell
Test-Path ".gsd/RESEARCH.md"
```

**Bash:**
```bash
test -f ".gsd/RESEARCH.md"
```

**If RESEARCH.md exists AND `--research` flag NOT set:**
- Display: `Using existing research: .gsd/RESEARCH.md`
- Skip to step 6
...
## 9. Update History (Optional)

If this is a `--redo`, append the previous `.gsd/PLAN.md` content to `.gsd/ARCHIVE.md` before overwriting.

```bash
git add .gsd/PLAN.md .gsd/RESEARCH.md .gsd/STATE.md
git commit -m "docs(phase-$PHASE): update execution plan"
```
