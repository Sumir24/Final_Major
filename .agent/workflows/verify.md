...
- `.gsd/ARCHIVE.md` — Historical context (replaces SUMMARY.md files)
</context>
...
- Context from `.gsd/ARCHIVE.md`
- Latest PLAN.md status
...
## 4. Create Verification Report (Compact Mode)

Write `.gsd/VERIFICATION.md` (active report) and append to `.gsd/VERIFICATION_HISTORY.md`.
...
Append a fix plan to `.gsd/PLAN.md`:
...
```bash
git add .gsd/VERIFICATION.md .gsd/VERIFICATION_HISTORY.md .gsd/STATE.md
